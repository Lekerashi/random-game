...
const LINE_BRANCHES = {
  ...
  // Tokaido through-running: line is reversed to south→north, branches diverge at Ueno
  'JR Tokaido Main Line': [
    { name: 'Tokyo', ja: '東京止まり', color: '#F7A600',
      stations: ['静岡','東静岡','草薙','清水','興津','由比','蒲原','新蒲原','富士川','富士','吉原','東田子の浦','原','片浜','沼津','三島','函南','熱海','湯河原','真鶴','根府川','早川','小田原','鴨宮','国府津','二宮','大磯','平塚','茅ケ崎','辻堂','藤沢','大船','戸塚','横浜','川崎','品川','新橋','東京'] },
